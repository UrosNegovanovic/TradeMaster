...
export const sr = {
  ...
  catalog: {
    ...
    emptyDescription: 'Prvo dodajte proizvode u asortiman.',
    goToInventory: 'Otvori asortiman',
    information: 'Podaci o katalogu',
    informationDescription: 'Unesite osnovne podatke za katalog.',
    name: 'Naziv kataloga',
    namePlaceholder: 'Unesite naziv kataloga',
    clientName: 'Naziv klijenta',
    clientNamePlaceholder: 'Unesite naziv klijenta (opciono)',
    discount: 'Popust (%)',
    notes: 'Napomena',
    notesPlaceholder: 'Dodatna napomena (opciono)',
    selectProducts: 'Izaberite proizvode',
    selectProductsDescription: 'Izaberite najmanje jedan proizvod za katalog.',
    pricePreview: 'Pregled cena',
    pricePreviewDescription: (discount: number) => `Cene sa primenjenim popustom od ${discount}%`,
    create: 'Kreiraj katalog',
    update: 'Sačuvaj katalog',
    created: 'Katalog je kreiran',
    createdDescription: (name: string) => `Katalog „${name}“ je spreman.`,
    createFailed: 'Katalog nije kreiran',
